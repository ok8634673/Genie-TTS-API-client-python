...
class TTSClientGUI:
    ...
    def setup_tools_tab(self):
        ...
        proxy_frame.grid(row=1, column=0, columnspan=3, sticky='w', pady=5)
        ...
        proxy_check.pack(side='left', padx=5)
        
        # 主客户端互联设置（可选）
        ttk.Label(config_frame, text="主客户端地址:").grid(row=2, column=0, sticky='w', padx=5, pady=5)
        self.master_api_entry = ttk.Entry(config_frame, width=30)
        self.master_api_entry.insert(0, self.master_api_url)
        self.master_api_entry.grid(row=2, column=1, padx=5, pady=5, sticky='we')
        ...
        connect_master_check.grid(row=2, column=2, padx=5, pady=5)
